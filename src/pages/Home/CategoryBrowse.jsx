        ...
        <Slider {...settings}>
          {categories.map((cat, idx) => (
            <div key={idx} className="px-2">
              <div
                className="flex flex-row items-center bg-gradient-to-tr from-white to-gray-50 rounded-xl shadow-md px-6 py-6 mb-6 cursor-pointer hover:shadow-lg hover:scale-[1.03] transition-transform h-full"
                title={cat.title}
              >
